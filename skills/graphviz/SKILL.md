...
description: Create, render, store, and publish Graphviz DOT diagrams for Ensemble-Retail. Use when a user asks to create a Graphviz graph locally, generate SVG/PNG diagram assets, store them in the repo, push diagram changes to GitHub, or prepare a Graphviz diagram for a Grafana Graphviz panel.
---
