...
| 2026-06-18 | This change | Context hygiene became explicit agent policy, with a repo-local skill and Codex session audit script for finding oversized tool-output and prompt-token drivers. |
...
- A context hygiene rule that caps exploratory output, avoids broad generated/session searches, and summarizes large tool results before they inflate future turns.
...
- [scripts/audit-codex-token-context.mjs](../../../scripts/audit-codex-token-context.mjs)
