...
Use this skill when creating or updating Graphviz diagrams, and to keep diagram
documentation current when the structure of the system changes.
...
5. If the diagram is intended for Grafana, first apply `dashboard-inventory` guidance, then add or update a dashboard panel:
...
```sh
git status --short
git add docs/graphviz README.md DIAGRAMS.md
