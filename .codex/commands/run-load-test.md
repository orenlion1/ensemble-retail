...
- The default steady API scenario uses `API_REQUEST_RPS=60`, `API_REQUEST_PRE_ALLOCATED_VUS=20`, and `API_REQUEST_MAX_VUS=65` for the current 60 requests/second protocol baseline.
