...
- The default browser-action scenario uses `BROWSER_ACTION_VUS=60`, `BROWSER_ACTION_DURATION=10m`, and `USER_ACTION_TARGET_RPS=10` so every expected Faro user-action family must reach at least 10 events/second.
